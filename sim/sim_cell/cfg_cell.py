...
cfg.hParams = {'celsius': 34, 'v_init': -72}  
cfg.verbose = 0
...
# Recording 
#------------------------------------------------------------------------------
allpops = ['PT5B'] #['IT2','PV2','SOM2','IT4','IT5A','PV5A','SOM5A','IT5B','PT5B','PV5B','SOM5B','IT6','CT6','PV6','SOM6']
cfg.cellsrec = 0
...
cfg.analysis['plotTraces'] = {'include': allpops, 'oneFigPer': 'trace', 'overlay': 1, 'figSize': (12,8), 'timeRange': [0,1000], 'saveFig': True, 'showFig': False,
...
cfg.weightNorm = False  # use weight normalization
